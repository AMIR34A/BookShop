...
namespace BookShop.Migrations.Identity
{
    ...
    [Migration("20230824154605_Change_Name_AspNetUsers_TB")]
    partial class Change_Name_AspNetUsers_TB
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("BookShop.Areas.Identity.Data.ApplicationUserRoles", b =>
                {
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityRoleClaim<string>", b =>
                {
                    b.HasOne("BookShop.Areas.Identity.Data.ApplicationRole", null)
                        .WithMany()
                        .HasForeignKey("RoleId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
